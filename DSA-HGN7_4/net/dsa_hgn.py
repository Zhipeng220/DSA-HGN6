...
class TCN_GCN_unit(nn.Module):
    ...
    [V7.3 Update] Reduced slow_rate default from 8 to 4 for better dynamic response
    """

    def __init__(self, in_channels, out_channels, A, stride=1, residual=True,
                 adaptive=True, kernel_size=5, dilations=[1, 2],
                 num_hyperedges=16, use_physical=False, num_joints=None,
                 slow_rate=4, # [FIX 3] Changed from 8 to 4
                 **kwargs):
        ...
        self.tcn1 = MultiScale_TemporalConv(
            ...
            slow_rate=slow_rate # [NEW] Pass slow_rate to TCN
        )
...
class Model(nn.Module):
    """
    DSA-HGN V7.3 Backbone
    Includes Continuum Memory (slow_rate=4)
    """
    ...
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None,
                 ...
                 num_hyperedges=16, use_physical=False,
                 slow_rate=4, # [FIX 3] Changed from 8 to 4
        ...
        shared_kwargs = {
            ...
            'slow_rate': slow_rate, # [NEW] Pass slow_rate to all units
            **kwargs
        }

        # [FIX] 10层网络,全部传递 shared_kwargs
...
# ... [Keep ChannelDifferentialBlock, DualBranchDSA_HGN, etc. unchanged] ...
